...
nice -20 numactl -N0 -m0 --physcpubind=4-13 -- env MISS_RATIO=1.0 LD_PRELOAD=/home/amanda/hemem/src/libhemem.so ./apps/flexkvs/kvsbench -t 4 -T 120 -w 20 -h 0.25 127.0.0.1:11211 -S $((32*1024*1024*1024)) &
flexkvs_pid=$!
wait ${flexkvs_pid}
