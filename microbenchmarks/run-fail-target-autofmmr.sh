...
OUTPUT=/home/amanda/hemem/microbenchmarks/data/fail-target-autofmmr
...
gups1_pid=$!
sleep 30
nice -20 numactl -C10,11 -m0 -- env START_CPU=10 MISS_RATIO=0.1 LD_PRELOAD=${HEMEM}/src/libhemem.so ${HEMEM}/microbenchmarks/gups-pebs 2 0 36 8 35 0 /tmp/gups-second.txt &
gups2_pid=$!
sleep 30
nice -20 numactl -C12,13 -m0 -- env START_CPU=12 MISS_RATIO=0.1 LD_PRELOAD=${HEMEM}/src/libhemem.so ${HEMEM}/microbenchmarks/gups-pebs 2 0 36 8 35 0 /tmp/gups-third.txt &
gups3_pid=$!
sleep 30
