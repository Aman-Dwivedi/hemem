...
nice -20 numactl -N0 -m0 --physcpubind=4-13 -- env MISS_RATIO=0.1 LD_PRELOAD=/home/amanda/hemem/src/libhemem.so ./apps/flexkvs/kvsbench -t 4 -T 500 -w 100 -h 0.20 -D 400 -H 0.3 127.0.0.1:11211 -S $((320*1024*1024*1024)) &
flexkvs_pid=$!
wait ${flexkvs_pid}
