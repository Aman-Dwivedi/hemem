MAXMEM=/home/amanda/hemem/
MODEL=/mnt/sda1/LLaMa2/Llama-2-70b-hf/ggml-model-f16.gguf
LLAMACPP=/home/amanda/hemem/apps/llama.cpp
...
nice -20 numactl -C0-3 -m0 -- ${MAXMEM}/src/central-manager &
central_pid=$!
sleep 30
nice -20 numactl -C4-23 -m0 -- env LD_PRELOAD=${MAXMEM}/src/libhemem-llama.so \
