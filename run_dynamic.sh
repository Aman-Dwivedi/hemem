...
central_pid=$!
sleep 30
nice -20 numactl -N0 -m0 --physcpubind=19-23 -- env MISS_RATIO=1.0 LD_PRELOAD=/home/amanda/hemem/src/libhemem-llama.so ./apps/llama.cpp/main -m /mnt/sda1/LLaMa2/Llama-2-70b-hf/ggml-model-f16.gguf --threads 4 -p "The key to happiness in one short sentence is:" -n 128 -e > data/dynamic/perf/llama.txt 2>&1 &
llama_pid=$!
